...
namespace Aura.Channel.Scripting.Scripts
{
	public abstract class DungeonScript : GeneralScript
	{
		...
		public bool ItemRequired; //If true, only fired when the item itself is dropped
		...
		public int Floorplan; //Unkown but required Seen 0 and 41 possibly a hall layout
		public bool TestDG;
		...
		public override bool Init()
		{
			...
			Log.Info("Loaded dungeon script {0}", Seed);
